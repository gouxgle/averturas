      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-gray-600">{TIPO_LABEL[operacion.tipo]}</span>
          </div>
          <p className="text-sm text-gray-600 mt-0.5">Creada el {formatDate(operacion.created_at)}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-400 shadow-lg p-5">
            <h3 className="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-3">Cliente</h3>
            <div className="flex items-center gap-3">
              ...
              <div>
                {cliente ? (
                  ...
                  <p className="text-sm text-gray-600">Sin cliente</p>
                )}
              </div>
            </div>
          </div>
          ...
          {/* Totales */}
          <div className="bg-white rounded-xl border border-gray-400 shadow-lg p-5 space-y-3">
            <h3 className="text-xs font-semibold text-gray-600 uppercase tracking-wider">Totales</h3>
          ...
          {(operacion.notas || operacion.fecha_validez) && (
            <div className="bg-white rounded-xl border border-gray-400 shadow-lg p-5 space-y-2">
              {operacion.fecha_validez && (
                <div>
                  <p className="text-xs text-gray-600">Validez</p>
          ...
          {esComercial && (
            <div className="bg-white rounded-xl border border-gray-400 shadow-lg overflow-hidden">
              ...
              {recibos.length === 0 ? (
                <p className="text-xs text-gray-600 text-center py-4">Sin recibos</p>
              ) : (
                <>
                    ...
                    {recibos.map(r => (
                      <Link key={r.id} to={`/recibos/${r.id}/editar`}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[10px] text-gray-600">{formatDate(r.fecha)} · {FORMA_PAGO_LABEL[r.forma_pago] ?? r.forma_pago}</p>
                        </div>
                  ...
                  <div className="px-3 py-2 border-t border-gray-200 space-y-1">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <span className={cn('font-semibold', saldoPendiente > 0.01 ? 'text-amber-600' : 'text-gray-600')}>
          ...
          {esComercial && (
            <div className="bg-white rounded-xl border border-gray-400 shadow-lg overflow-hidden">
              ...
              {remitos.length === 0 ? (
                <p className="text-xs text-gray-600 text-center py-4">Sin remitos</p>
              ) : (
                <div className="divide-y divide-gray-50">
                  {remitos.map(rm => (
                    <Link key={rm.id} to={`/remitos/${rm.id}/editar`}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-gray-600">{formatDate(rm.fecha_emision)}</p>
                      </div>
              ...
              <div className="divide-y divide-gray-50">
                {operacion.historial.map(h => (
                  <div key={h.id} className="px-5 py-3 flex items-center gap-3">
                    ...
                    <p className="text-xs text-gray-600 shrink-0">{formatDate(h.created_at)}</p>
                  </div>
                ))}
              </div>
            </div>
