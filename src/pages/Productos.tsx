      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90dvh] overflow-y-auto">
        ...
        <div className="p-5 space-y-4">
          ...
          {producto.proveedor?.nombre && colorProv && (
            <div className="flex items-center gap-2.5 rounded-xl border px-3 py-2.5" style={colorProv.badgeStyle}>
          ...
          {(producto.material || producto.linea?.nombre || (producto.tipo_abertura as any)?.nombre || (producto.sistema as any)?.nombre || producto.color || attrs.length > 0) && (
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-1.5">
                ...
                {producto.linea?.nombre && <Row k="Línea" v={producto.linea.nombre}/>}
