...
const NAV_GROUPS: { label?: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/proveedores',   label: 'Proveedores',      icon: Factory,         activeColor: 'text-amber-400',   activeBg: 'bg-amber-500/10' },
    ],
  },
  {
    label: 'Sistema',
    items: [
      ...
      { to: '/ayuda',         label: 'Manuales del sistema', icon: BookOpen,   activeColor: 'text-violet-400',  activeBg: 'bg-violet-500/10' },
